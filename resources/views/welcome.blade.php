...
<head>
    ...
    <title>Welcome to the Cloud9 Guild!</title>
...
<body>
    ...
    <div id="content">
        ...
        <div id="welcome">
            <img src="/cloud9_shield256.png" alt="Cloud9 Shield"/>
            <h1><span>Cloud9</span> Guild</h1>
            <p>
                Welcome to the Cloud9 Guild! Join your fellow Rubyists and
                Cloud-Niners as you use the world's most advanced browser-based 
                IDE to learn the basics of the Twilio platform.
            </p>
            <p>
        ...
        <p>
            ...
            <a href="https://github.com/twilio/starter-cloud9">README.md in your 
